#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e470ec22fc33ba006c42cce10778844f9e40466a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e470ec22fc33ba006c42cce10778844f9e40466a", @"/Views/Map/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "45a483faa3714522bb10b59203160659", async() => {
    ...
    ");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(16115, 64174, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3a44f83869c14157bbd09ac54ee02852", async() => {
...
");
    ...
    <script>
        ...
        pouSlider.oninput = function () {
            pouVa");
                WriteLiteral(@"lue.innerHTML = this.value;
        }
  ...
  ");
            ...
            //        ""text-color"": ""#333"",
            ");
                WriteLiteral(@"//        ""text-halo-color"": ""hsl(0, 0%, 100%)"",
            //        ""text-halo-width"": 1.5,
            //        ""text-halo-blur"": 1
            //    }
            //});
 ...
 ");
       ...
       ");
        ...
        function choropleth(op");
            ...
            //Population density
                ...
                map.setPaintProperty(""cheo"", 'fill-color',");
                WriteLiteral(@" [""get"", [""to-string"", [""get"", ""LGA_CODE18""]], [""literal"", desyCheo]]);
        ...
        function getDesyColor(d) {
           ");
                WriteLiteral(@" return d > 200 ? '#723122' :
                d > 50 ? '#8B4225' :
                    d > 20 ? '#A25626' :
                        d > 8 ? '#B86B25' :
                            d > 5 ? '#CA8323' :
    ...
    ");
        ...
        function recommendation() {
            ...
            var pouWeight = parseFloat(p");
                WriteLiteral(@"ouSlider.value);
 ...
 ");
                WriteLiteral(@"                   if (rates[allCode[i]] != -1 && object != null && object[""LGA_Code""] != """"
            ...
            for (var i = 0; i < list.length; i++) {
                var recomdList = document.getElementById('recomd-list');
                recomdList.innerHTML += '<div onclick=""flytoPoly(' + parseInt(list[i][""LGA_Code""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
                    + li");
                WriteLiteral(@"st[i][""LGA""] + '</h5> <small class=""text-muted"" >Top ' + (i + 1) + '</small> </div > <p class=""mb-1"">'
        ...
        function filter() {
            ...
            var minBudget = parseInt(documen");
                WriteLiteral(@"t.getElementById(""min-bgt"").value);
            ...
            for (var i = 0; i < list.length; i++) {
                var filterList = document.getElementById('list');
                filterList.innerHTML += '<div onclick=""flytoPoly(' + parseInt(list[i][""LGA_Code""]) + '");
                WriteLiteral(@")"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h6 class=""mb-1"">'
...
");
                WriteLiteral(@"        function jsUcfirst(string) {
    ...
    ");
                WriteLiteral(@"        return new Date(Date.parse(mon + "" 1, 2012"")).getMonth() + 1
        }
        //is number
