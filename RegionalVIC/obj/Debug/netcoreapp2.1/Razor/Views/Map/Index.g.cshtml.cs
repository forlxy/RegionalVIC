#pragma checksum "/Users/sysadmin/GitKraken/RegionalVIC/RegionalVIC/Views/Map/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e65788c2c7300e3c95663335c4e6698dc05c95e8"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e65788c2c7300e3c95663335c4e6698dc05c95e8", @"/Views/Map/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "21c6dbd1824a45fd898dd50ac2bf749b", async() => {
    ...
    <script src='https://api.mapbo");
            ...
            WriteLiteral("\n\n");
            EndContext();
            BeginContext(15510, 63859, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "02e7f91de69d429a85ea74b1a8f34b2b", async() => {
...
");
                WriteLiteral(@"            rcMap.set('23110', getRandomColor());
    ...
    ");
                WriteLiteral(@"        rcMap.set('25150', getRandomColor());
        ...
        ");
                ...
                ""228");
                WriteLiteral(@"30"": rcMap.get('22830'),
        ...
        map.on('load', function () {
            ...
            map.addLayer({
                ...
                ""paint"": {
                    ""fill-color"":
       ");
                WriteLiteral(@"                 [""get"", [""to-string"", [""get"", ""LGA_CODE18""]], [""literal"", cheo]],
                    ""fill-opacity"": [""case"",
                        [""boolean"", [""feature-state"", ""hover""], false],
                        1,
                        0.5
            ...
            map.on(""mou");
                WriteLiteral(@"seleave"", ""state-fills"", function () {
      ...
      ");
            ...
            map.on('click', 'state-fills', function (e) {
                ...
                var sel1 = jQuery(""#sel1 option:selecte");
                WriteLiteral(@"d"").val();
        ...
        function changeSelect() {
            ...
            if (typeSelectValue == ""House"") {
                ...
                $(""#sel1"").val(""1"");
                $('#sel1').find('option:con");
                WriteLiteral(@"tains(4)').prop('disabled', true);
            }
        }
     ...
     ");
        ...
        function choropleth(option) {
            ...
            if (option == ""a"") {
                ...
                for (var i = 0; i < allCode.length; i++) {
                    ...
                    displayList[[allCode[i]]] = parseInt(getItem(tmpList[0], ""median"")) != 0 ? ""House median is $"" + parseInt(getItem(tmpList[0], ""median""))
                        + "".<p> Number of recorded house: "" + parseInt(getItem(tmpList[0], ""count"")) + ""</p>");
            ...
            //Safety
                ...
                for (var j = 0; j < objects.length; j++) {
                    for (var i =");
                WriteLiteral(@" 0; i < allCode.length; i++) {
      ...
      ");
        ...
        // get color depending on population density va");
                WriteLiteral(@"lue
        ...
        function recommendation() {
            ...
            var crmWeight = parseFloat(crmSlid");
            ...
            for (var i = 0; i < 10; i++) {
                var recomdList = document.getElementById('recomd-list');
                recomdList.innerHTML += '<a href=""javascript:flytoPoly(' + parseInt(list[i][""LGA_Code""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-betwee");
                WriteLiteral(@"n"" > <h5 class=""mb-1"">'
        ...
        function filter() {
            ...
            for (var i = 0; i < list.length; i++) {
                var filterList = document.getElementById('list');
                filterList.innerHTML += '<a href=""javas");
                WriteLiteral(@"cript:flytoPoly(' + parseInt(list[i][""LGA_Code""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h6 class=""mb-1"">'
        ...
        var getItems = function ()
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                if (object != null && parseInt(object[""LGA_Code""]) == parseInt(lgaCode)) {
                    ...
                    for (var j = 0; j < Object.keys(args).leng");
                WriteLiteral(@"th; j++) {
    ...
    <script src=""/js/jqBootstrapValidatio");
