#pragma checksum "C:\Users\kasal\Source\Repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "da2cc5eb0d69fd1a031461a1057ce2b1b3d2fe7b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"da2cc5eb0d69fd1a031461a1057ce2b1b3d2fe7b", @"/Views/Map/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3f073722f5aa401b8b6d9e080b4d9dd8", async() => {
    ...
    ");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(16115, 65292, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cacce8c3a67c4a1da908db1331a1f9b2", async() => {
        ...
        function choropleth(option) {
            ...
            if (option == ""a"") {
                ...
                for (var i = 0; i < allCode.length; i++) {
                    ...
                    var data = ""{code:'"" + allCode[i] + ""', bedroom:'"" + sel1 + ""', type:'"" + sel2 + ""'}""
                    $.ajax({
                        url: '");
                EndContext();
                BeginContext(61458, 30, false);
#line 1512 "C:\Users\kasal\Source\Repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml"
                         Write(Url.Action("getMedian", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(61488, 19912, true);
                WriteLiteral(@"',
                        type: 'POST',
                    ...
                    //    (getMonthF");
                WriteLiteral(@"romString(a.month) < getMonthFromString(b.month)) ? 1 : -1)
            ...
            //Safety
                ...
                ma");
                WriteLiteral(@"p.setPaintProperty(""cheo"", 'fill-color', [""get"", [""to-string"", [""get"", ""LGA_CODE18""]], [""literal"", crimeCheo]]);
            ...
            //Population density
                ...
                WriteLiteral(@" parseFloat(object[""Density""]) != 0 ? ""Density: "" + parseFloat(object[""Density""]).toFixed(2) + "". <p>Population: "" + parseInt(object[""Population""]) + '</p>' : ""No record"";
        ...
        function recommendation() {
            ...
            var minBudget = isNaN(minB");
                WriteLiteral(@"udget) ? 0 : minBudget;
 ...
 ");
         ...
         ");
                WriteLiteral(@"   for (var i = 0; i < 10; i++) {
                var recomdList = document.getElementById('recomd-list');
            ...
            if (list.length == 0) {
                ...
                filterList.innerHTML += '<div class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">' +
                    'No rec");
                WriteLiteral(@"ord within this price range</h5> <small class=""text-muted"" ></small> </div> <p class=""mb-1"">'
        ...
        function filter() {
            ...
            if (list.length == 0) {
                var filterList = document.getElementById('list');
                filterList.innerHTML += '<div class=""list-gro");
                WriteLiteral(@"up-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h6 class=""mb-1"">' +
        ...
        function showPolygonArea(e) {
            ...
            new ");
                WriteLiteral(@"L.Marker(e.layer.getBounds().getCenter()).addTo(featureGroup);
