#pragma checksum "C:\Users\kasal\Source\Repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dce9be9eefb7da08a4752816296adae92f040b4b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dce9be9eefb7da08a4752816296adae92f040b4b", @"/Views/Map/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2734cbc7720142cb9b703da1633f6473", async() => {
    ...
    ");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(16115, 69884, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c64287e4bfcc4216b188f7f5a1f25157", async() => {
...
");
                WriteLiteral(@"                ""20660"": rcMap.get('20660'),
   ...
   ");
            ...
            //$.getJSON('/LGA_2018_AUST_VIC_ID.json', function (data) {
            //    customData = (data);
       ...
       ");
            ...
            map.on(""mousemove"", ""state-fills"", function (e) {
               ");
                WriteLiteral(@" map.getCanvas().style.cursor = e.point.length ? 'pointer' : '';
     ...
     ");
        ...
        function choropleth(option) {
            ...
            if (option == ""a"") {
                ...
                var sel1 = jQuery(""#sel1 option:selected"").val();
                v");
                WriteLiteral("ar sel2 = jQuery(\"#sel2 option:selected\").val();\r\n\r\n");
                EndContext();
                BeginContext(63904, 56, true);
                WriteLiteral("                $.ajax({\r\n                        url: \'");
                EndContext();
                BeginContext(63961, 33, false);
#line 1565 "C:\Users\kasal\Source\Repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml"
                         Write(Url.Action("getAllMedian", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(63994, 2698, true);
                WriteLiteral(@"',
                        type: 'POST',
                        data: { bedroom: sel1, type: sel2},
                        success: function(data)
                        {
                            ...
                            //cheo[code] = getColor(parseInt(median))
                            //displayList[code] = parseInt(median) != 0 ? ""Ho");
                WriteLiteral(@"use median is $"" + parseInt(median)
                            //    + ""."" : ""No record"";
         ...
         ");
                WriteLiteral(@"               //var object = objects[j];
...
#line hidden
                ...
                WriteLiteral(@"',
                        ...
                        success: function(data)
                        {
                            ...
                            var icdNum = result[""incident""];

                            displayList[code] = parseFloat(rate) != 0 ? ""Criminal Rate: "" + parseFloat(rate).toFixed(2) + ""%. <p>Incident number: "" + parseInt(icdNum) + '</p>' : ""No record"";
                            crimeCheo[code] = getCrimeColor(parseFloat(rate));
                            ...
                            map.setLayoutProperty(""cheo"", 'visibility', 'visible');
                      ");
                WriteLiteral(@"      //map.setPaintProperty(""cheo"", 'fill-color', [""get"", [""to-string"", [""get"", ""LGA_CODE18""]], [""literal"", crimeCheo]]);
   ...
   ");
                WriteLiteral(@"                     //if (object != null && parseInt(object[""LGA Code""]) == allCode[i]) {
                        ...
                        url: '");
                EndContext();
                BeginContext(69291, 31, false);
#line 1668 "C:\Users\kasal\Source\Repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml"
                         Write(Url.Action("getDensity", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(69322, 16670, true);
                WriteLiteral(@"',
                        type: 'POST',
                        data: { code: allCode[i] },
                        success: function(data)
                        {
                            ...
                            displayList[code] = parseFloat(density) != 0 ? ""Density: "" + parseFloat(density).toFixed(2) + "". <p>Population: "" + parseInt(population) + '</p>' : ""No record"";
                            desyCheo[code] = getDesyColor(parseFloat(density));
                            ...
                            map.setLayoutProperty(""cheo"", 'visibility', 'visible');
            ");
                WriteLiteral(@"                //map.setPaintProperty(""cheo"", 'fill-color', [""get"", [""to-string"", [""get"", ""LGA_CODE18""]], [""literal"", desyCheo]]);
        ...
        // get color depending on house pric");
...
");
                WriteLiteral(@"            var desyObject = desyTable;
            ...
            for (var i = 0; i < allCode.length; i++) {
                for (var j = 0; j < objects.length; j++) {
                    ...
                    if (rates[allCode[i]] != -1 && object != null && object[""LGA Code""] != """"
                        && object[""Density""] != null &&
                   ");
                WriteLiteral(@"     parseInt(object[""LGA Code""]) === allCode[i]) {
            ...
            for (var i = 0; i < 10; i++) {
                var recomdList = document.getElementById('recomd-list');
                recomdList.innerHTML += '<a href=""javascript:");
                WriteLiteral(@"flytoPoly(' + parseInt(list[i][""LGA_Code""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
...
");
        ...
        function filter() {
            ...
            if (list.length == 0) {
                ...
                filterList.innerHTML += '<div class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h6 class=""mb-1"">' +
                    'No record ");
                WriteLiteral(@"within this price range</h6> <small class=""text-muted"" ></small> </div> <p class=""mb-1"">'
                    + 'Change your price range and try again</p> </div>';
        ...
        //Return value
        var getItems = function ()   /*function getItems(objects, lgaCode, attriName, attriValue, year = """", yearValue = """")*/
        {
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                var ready = true;
                if (object != nul");
                WriteLiteral(@"l && parseInt(object[""LGA_Code""]) == parseInt(lgaCode)) {
        ...
        f");
                WriteLiteral(@"unction getItem(object, name) {
