#pragma checksum "/Users/sysadmin/GitKraken/RegionalVIC/RegionalVIC/Views/Map/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fe87c3ec0b25cde9414eea8e6db5ccf3a540df7e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fe87c3ec0b25cde9414eea8e6db5ccf3a540df7e", @"/Views/Map/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6fbf6d1b803b4328bef15e19e2b0bf9d", async() => {
    ...
    ");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(16115, 64237, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6f8259e897954c708f95536cdadd5e77", async() => {
...
");
 ...
 ");
        ...
        function choropleth(option) {
            ...
            if (option == ""a"") {
                ...
                for (var i = 0; i < allCode.length; i++) {
                    ...
                    displayList[[allCode[i]]] = parseInt(getItem(tmpList[0], ""median"")) != 0 ? ""House median is $"" + parseInt(getItem(tmpList[0], ""median""))
                        + "".<p> Number of recorded house: "" + parseInt(getItem(tmpList[0], ""co");
                WriteLiteral(@"unt"")) + ""</p>"" : ""No record"";
            ...
            //Safety
                ...
                for (var j = 0; j < objects.length; j++) {
                  ");
                WriteLiteral(@"  for (var i = 0; i < allCode.length; i++) {
   ...
   ");
        ...
        // get color depending on populat");
                WriteLiteral(@"ion density value
...
");
        ...
        function recommendation() {
            ...
            var crmWeight = pars");
                WriteLiteral(@"eFloat(crmSlider.value);
 ...
 ");
            ...
            for (var i = 0; i < 10; i++) {
                var recomdList = document.getElementById('recomd-list');
                recomdList.innerHTML += '<a href=""javascript:flytoPoly(' + parseInt(list[i][""LGA_Code""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-");
                WriteLiteral(@"content-between"" > <h5 class=""mb-1"">'
        ...
        function filter() {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                WriteLiteral(@"<a href=""javascript:flytoPoly(' + parseInt(list[i][""LGA_Code""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h6 class=""mb-1"">'
        ...
        var getItems = function ()
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                if (object != null && parseInt(object[""LGA_Code""]) == parseInt(lgaCode)) {
                    ...
                    for (var j = 0; j < Obje");
                WriteLiteral(@"ct.keys(args).length; j++) {
    ...
    <script src=""/js");
                WriteLiteral("/jqBootstrapValidation.js\"></script>\r\n    <script src=\"/js/contact_me.js\"></script>\r\n    <!-- Custom scripts for this template -->\r\n    <script src=\"/js/agency.min.js\"></script>\r\n\r\n");
                EndContext();
            }
            );
