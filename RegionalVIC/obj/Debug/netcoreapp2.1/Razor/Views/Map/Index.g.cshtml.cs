#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8cc278761b8ebabdd1c90be205e18dd66b079e5c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8cc278761b8ebabdd1c90be205e18dd66b079e5c", @"/Views/Map/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "668767c3907c4f50ae1b885b4c2f219e", async() => {
    ...
    ");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(16115, 61218, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "597decf059ef410e8c1678386e7442c2", async() => {
                BeginContext(16121, 8452, true);
                WriteLiteral(@"
            ...
            <div class=""row"">
                <div class=""col-lg-7 col-md-6 col-sm-12"">
                    <div class=""container"">
                        ...
                        <div id='state-legend' class='legend' style=""display: none"">
                            ...
                            <div><span style='b");
                WriteLiteral(@"ackground-color: #CA8323'></span>250</div>
                        ...
                        <div id='state-crime-legend' class='legend' style=""display: none"">
                            ...
                            <div><span style='background-color: #CA8323'></span>");
                WriteLiteral(@"5%</div>
                ...
                <div class=""col-lg-5 col-md-6 col-sm-12"">
                    ...
                    <ul class=""nav nav-tabs"">
                        ...
                        <li class=""nav-item"">
    ");
                WriteLiteral(@"                        <a class=""nav-link"" data-toggle=""tab"" href=""#recommendation"">Recommendation</a>
                        </li>
...
");
    ...
    <script>
        ...
        function flytoPoly(LGA_Code) {
            ...
            var features = map.querySourceFeatures({ layers: ['state-fills'] });
                ...
                if (features.length) {
                    ...
                    features.forEach(function (feature) {
                        if (parseInt(feature.properties.LGA_CODE18) === LGA_Code) {
                            ...
                            var ");
                WriteLiteral(@"coords = feature.geometry.coordinates;
        ...
        map.on('load', function () {
            ...
            map.addLayer({
                ...
                ""paint"": {
                    ""fill-color"":
                        [""get"", [""to-string");
                WriteLiteral(@""", [""get"", ""LGA_CODE18""]], [""literal"", myData]],
                    ""fill-opacity"": [""case"",
            ...
            // feature state for the fe");
                WriteLiteral(@"ature under the mouse.
        ...
        function choropleth(option) {
            ...
            if (option == ""a"") {
                ...
                for (var i = 0; i < allCode.length; i++) {
                    ...
                    displayList[[allCode[i]]] = parseInt(getItem(tmpList[0], ""median"")) != 0 ? ""House median is $"" + parseInt(getI");
                WriteLiteral(@"tem(tmpList[0], ""median""))
            ...
            //Safety
                ...
                map.setLayoutProperty(""state-fills"", 'visibility', 'none');
                ma");
                WriteLiteral(@"p.setLayoutProperty(""cheo"", 'visibility', 'visible');
                ...
                for (var j = 0; j < objects.length; j++) {
                    for (var i = 0; i < allCode.length; i++) {
                        ...
                        if (object != null && parseInt(object[""LGA Code""]) == allCode[i]) {
                            ...
                            desyCheo[a");
                WriteLiteral(@"llCode[i]] = getDesyColor(parseFloat(object[""Density""]));
                        }
                    }
                }
        ...
        // get color depending on house price v");
                WriteLiteral(@"alue
        function getColor(d) {
            return d > 550 ? '#723122' :
                d > 450 ? '#8B4225' :
     ...
     ");
                WriteLiteral(@"               var object = new Object;
...
");
            ...
            for (var i = 0; i < list.length; i++) {
                var recomdList = document.getElementById('recomd-list');
                recomdList.innerHTML += '<div onclick=""flytoPoly(' + parseInt(list[i][""LGA_Co");
                WriteLiteral(@"de""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
      ...
      ");
        ...
        ");
                WriteLiteral(@"            + 'Change your price range and try again</p> </div>';
        ...
        var getItems = function ()
            ...
            for (var i = 0; i < objects.length; i++) {
                var object = objects[i];
                var ready = true;
                if (object != null && parseInt(object[""LGA_Code""]) == parseInt");
        ...
        function getItem(object, name) {
            ");
                WriteLiteral(@"return object != null ? object[name] : 0
        }
        //Get month number
