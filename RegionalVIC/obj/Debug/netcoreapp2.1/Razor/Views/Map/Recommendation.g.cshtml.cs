#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9a2b5b9bde4f51cc72955a185ac27994c7e0b755"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9a2b5b9bde4f51cc72955a185ac27994c7e0b755", @"/Views/Map/Recommendation.cshtml")]
...
");
            EndContext();
            BeginContext(5734, 19523, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3649d0458f984475b9c6f331ba1c15d0", async() => {
                BeginContext(5740, 15530, true);
                WriteLiteral(@"
    ...
    <script src='https://cdnjs.cloudflare.com/ajax/libs/d3-tip/0");
                WriteLiteral(@".7.1/d3-tip.min.js'></script>
    ...
    <script>
        ...
        function ajax2() {
            ...
            return $.ajax({
                ...
                success: function (data) { // callback for successful completion
                    var tmpObj = JSON.parse(data);
             ");
                WriteLiteral(@"       lga[""features""] = lga[""features""].concat(tmpObj[""features""]);
                },
                error: function () { // callback if there's an error
                    alert(""error"");
                }
        ...
        function ajax4() {
            // NOTE:  This function m");
                WriteLiteral(@"ust return the value
            //        from calling the $.ajax() method.
            return $.ajax({
        ...
        function ajax5() {
            ...
            return $.ajax({
                ...
                dataType: 'text',
                success: function (data) { // callback f");
                WriteLiteral(@"or successful completion
                    var tmpObj = JSON.parse(data);
                    lga[""features""] = lga[""features""].concat(tmpObj[""features""]);
                },
                error: function () { // callback if there's an error
   ...
   ");
            ...
            lga.features.forEach(function (feature) {
                ...
                if (feature.geometry != null) {
                    ...
                    centroidPt.properties.LGA_CODE18 = feature.properties.L");
                WriteLiteral(@"GA_CODE18;
            ...
            map.on(""mousemove"", ""state-fills"", function (e) {
                ...
                var code = e.feature");
                WriteLiteral(@"s[0].properties.LGA_CODE18;
            ...
            map.on('mousemove', ""cheo"", function (e) {
                ...
                if (states.length > 0) {
                    for (var i = 0; i < states.length; i++) {
                     ...
                     ");
                WriteLiteral(@"       document.getElementById('pd').innerHTML = '<h5><strong>' + name + '</strong></h5><div class=""content-line"">' + displayList[states[0].properties.LGA_CODE18] + '</div>';
                            break;
                        }
                    }
                } else {
            ...
            map.on('click', 'state-fills', function (e) {
                ...
                var vid");
                WriteLiteral("eo = document.querySelector(\'#card-video\');\r\n                video.style.display = \"none\";\r\n                $.ajax({\r\n                    /**/\r\n                    url: \'");
                EndContext();
                BeginContext(21271, 28, false);
#line 635 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                     Write(Url.Action("getInfo", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(21299, 3951, true);
                WriteLiteral(@"',
                    /**/
                    type: 'POST',
                    data: { code: lgaCode },
...
");
            ...
            EndContext();
            BeginContext(25257, 106, true);
            WriteLiteral("\r\n<style>\r\n\r\n    section {\r\n        margin-bottom: 0px;\r\n        padding: 20px 0;\r\n    }\r\n\r\n    </style>\r\n");
            EndContext();
            BeginContext(25363, 48379, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fd1270f39e1c4a17856cfdc2f6d82824", async() => {
                BeginContext(25369, 2222, true);
                WriteLiteral(@"
    ...
    <section>
        <div class=""container"">
            ...
            <div class=""row"">
                ...
                <div class=""col-4"">
                    ...
                    <div class=""form-group"">
                        <label for=""range-slider""
                               class=""font--18 text--lebel""");
                WriteLiteral(@">Your budget (per week)</label>
                        <div class=""range-slider"">
               ...
               ");
                WriteLiteral(@"             Choose your interested industry
                        </label>
            ...
            <div class=""row"">
                ...
                <div class=""mt-3 col-12 text-center"">
                    <a class=""btn btn-primary btn-xl js-scroll-trigger disabled"" id=""rmd-confirm"" href=""#mapsection""><i id=""button-spinner"" class=""fa fa-circle-o-notch fa-spin""></i>&nbsp;Loading</a>
                </div>
...
");
    ...
    <script>
        ...
        var map = new mapboxgl.Map({
            ...
            //style: 'mapbox://style");
                WriteLiteral(@"s/mapbox/light-v9',
    ...
    var initMap = false;
        function formRegionColorMap() {
            ...
            rcMap.set('");
                WriteLiteral(@"21270', getRandomColor());
            ...
            rcMap.set('26810', getR");
                WriteLiteral(@"andomColor());
      ...
      ");
            ...
            $.ajax({
                ...
                url: '");
                EndContext();
                BeginContext(55896, 34, false);
#line 1368 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                 Write(Url.Action("setCodeColors", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(55930, 1570, true);
                WriteLiteral(@"',
                /**/
                type: 'POST',
    ...
    function flyto");
                WriteLiteral(@"Poly(LGA_Code, option=1) {
                ...
                features.forEach(function (feature) {
                    if (parseInt(feature.properties.LGA_CODE18) === parseInt(LGA_Code)) {
                        ...
                        $.ajax({
                            ...
                            url: '");
                EndContext();
                BeginContext(57501, 30, false);
#line 1419 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                             Write(Url.Action("getLngLat", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(57531, 9888, true);
                WriteLiteral(@"',
                            /**/
                            type: 'POST',
                            data: { code: LGA_Code },
  ...
  ");
                WriteLiteral(@"          map.setLayoutProperty(""cheo"", 'visibility', 'none');
        ...
        $pourange.ionRangeSlider({
            ...
            values: [
             ");
                WriteLiteral(@"   ""Not important"", ""Less important"", ""Average"", ""Important"", ""Very Important""
            ],
            onStart: updateP,
            onFinish: updateP
        });
      ...
      ");
                WriteLiteral(@"      var typeSelectValue = $(""#inputCountryR"").val();
        ...
        function initialIndustryListR() {
            ...
            /**/
                url: '");
                EndContext();
                BeginContext(67420, 35, false);
#line 1761 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                 Write(Url.Action("getAllIndustry", "Job"));

#line default
#line hidden
                EndContext();
                BeginContext(67455, 1005, true);
                WriteLiteral(@"',
            /**/
            type: 'POST',
            data: { },
        ...
        function initialCountryListR() {
            ...
            url: '");
                EndContext();
                BeginContext(68461, 34, false);
#line 1788 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
             Write(Url.Action("getAllCountry", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(68495, 2225, true);
                WriteLiteral(@"',
            /**/
            type: 'POST',
            data: { },
    ...
    function recommendation() {
        ...
        document.querySelector('#ca");
                WriteLiteral("rd-content\').style.display = \"none\";\r\n        document.querySelector(\'#list-name\').innerHTML = \"Recommendation result\";\r\n\r\n        $.ajax({\r\n            /**/\r\n            url: \'");
                EndContext();
                BeginContext(70721, 38, false);
#line 1852 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
             Write(Url.Action("getRecommendation", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(70759, 2976, true);
                WriteLiteral(@"',
            /**/
            type: 'POST',
