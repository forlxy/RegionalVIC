#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Home\Map.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "25a0c9b0b055ec42189320d79f0c6808f8cfe785"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"25a0c9b0b055ec42189320d79f0c6808f8cfe785", @"/Views/Home/Map.cshtml")]
...
");
            EndContext();
            BeginContext(12896, 2170, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a22c7c125951473f8cc438d67350901a", async() => {
                BeginContext(12902, 2157, true);
                WriteLiteral(@"
    ...
    <script src='https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geoc");
            ...
            EndContext();
            BeginContext(15066, 4, true);
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(15070, 47821, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e803bf38ba5d4fd2b5d7ac58d91590d3", async() => {
                BeginContext(15076, 7656, true);
                WriteLiteral(@"
...
");
    ...
    <script>
        ...
        function formRegionColorMap() {
            ...
            rcMap.set");
                WriteLiteral(@"('21370', getRandomColor());
            ...
            rcMap.set('23");
                WriteLiteral(@"190', getRandomColor());
    ...
    ");
                WriteLiteral(@"            ""22980"": rcMap.get('22980'),
        ...
        map.on('load', function () {
         ...
         ");
            ...
            map.on(""mouseleave"", ""state-fills"", function () {
                if (hoveredStateId) {
                    map.setFeatureState({ source: 'states', id: hoveredStateId }, { hov");
            ...
            map.on('click', 'state-fills', function (e) {
                ...
                //        labels.push(getMonthFromString(getIt");
                WriteLiteral(@"em(list[i], ""month"")) + ""/"" + getItem(list[i], ""year""));
      ...
      ");
        ...
        function choropleth(option) {
            ...
            if (option == ""a"") {
                ...
                for (var j");
                WriteLiteral(@" = 0; j < objects.length; j++) {
        ...
        function forwardGeocoder(query) {
            ...
            for (var i = 0; i < customData.features.length; i++) {
                ...
                // handle queries w");
                WriteLiteral(@"ith different capitalization than the source data by calling toLowerCase()
 ...
 ");
                WriteLiteral(@"           var headers = allTextLines[0].split(',');
            lines = [];
    ...
    ");
        ...
        function recommendation() {
            ...
            for (var i = 0; i < allCode.length; i++) {
                for (var j = 0; j < objects.length; j++) {
                    ...
                    if (rates[allCode[i]] != -1 && object != null && object[""LGA_Code""] != """"
                        && object[""Year""] == """);
                WriteLiteral(@"2018"" && object[""Rate""] != null &&
                        parseInt(object[""LGA_Code""]) === allCode[i]) {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                recomdList.innerHTM");
                WriteLiteral(@"L += '<a href=""#"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
        ...
        function filter() {
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                if (object != null && object[""median""] != """" &&
                    parseInt(object[""median""]) > minBudget && parseInt(object[""median""]) < maxBudge");
                WriteLiteral(@"t) {
                    if (object[""year""] == ""2018"")
                        list.push(object);
                }
        ...
        var getItems = function ()
            ...
            for (var i = 0; i < objects.length; i++) {
                ...
                ");
                WriteLiteral(@"            //if (year != """" && yearValue != """")
