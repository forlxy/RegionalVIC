#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "767ff3e9599c9ab04f67ef768733ffdd2cbe5a7a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"767ff3e9599c9ab04f67ef768733ffdd2cbe5a7a", @"/Views/Map/Recommendation.cshtml")]
...
<style>
    ...
    * on the page. */
    ...
    .axis {
       ");
            WriteLiteral(@" font: 14px sans-serif;
    }
...
");
            EndContext();
            BeginContext(6151, 18829, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8f740ee09c0d4a2cbfa67cca56fb8a42", async() => {
                BeginContext(6157, 15888, true);
                WriteLiteral(@"
    ...
    <");
                WriteLiteral(@"script src=""https://d3js.org/d3.v5.min.js""></script>
        ...
        window.onload = function () {
            ...
            function ajax2() {
                return $.ajax({
                    ...
                    error: function () { // callback if there's ");
                WriteLiteral(@"an error
                        alert(""error"");
                    }
                });
            }
...
");
            ...
            function ajax5() {
                return $.ajax({
                    ...
                    error: function () ");
                WriteLiteral(@"{ // callback if there's an error
                        alert(""error"");
                    }
                });
            }
            ...
            ");
                ...
                lga.features.forEach(function (feature) {
                    ...
                    if (feature.geometry != null) {
                        ...
                        centroidPt.properties.title = fe");
                WriteLiteral(@"ature.properties.LGA_NAME18;
                ...
                map.addLayer({
                    ...
                    ""layout"": {
                        ...
                        ""text-padding"": 3,
      ");
                WriteLiteral(@"                  ""text-letter-spacing"": 0.1,
                        ""text-max-width"": 7
                    },
                    ""paint"": {
                        ""text-color"":
                ...
                map.on('mousemove', ""cheo"", function (e) {
                    ...
                    if (states.length > 0) {
                        for (var i = 0; i < states.length; i++) {
                            if (state");
                WriteLiteral(@"s[0].layer.id == ""cheo"") {
         ...
         ");
                ...
                WriteLiteral(@");
                    ...
                    $.ajax({
                        ...
                        url: '");
                EndContext();
                BeginContext(22046, 28, false);
#line 634 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                         Write(Url.Action("getInfo", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(22074, 2899, true);
                WriteLiteral(@"',
                        /**/
                        type: 'POST',
                        data: { code: lgaCode },
...
");
            ...
            EndContext();
            BeginContext(24980, 106, true);
            WriteLiteral("\r\n<style>\r\n\r\n    section {\r\n        margin-bottom: 0px;\r\n        padding: 20px 0;\r\n    }\r\n\r\n    </style>\r\n");
            EndContext();
            BeginContext(25086, 48157, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b482c6de38c94ab5973c5650a4e9eda3", async() => {
                BeginContext(25092, 2231, true);
                WriteLiteral(@"
        ...
        ");
                ...
                <div class=""col-4"">
                    ...
                    <div class=""form-group"">
                        <label for=""inputIndustryR"" class=""font--18 text--lebel"">
                            Cho");
                WriteLiteral(@"ose your interested industry
                        </label>
            ...
            <div class=""row"">
                ...
                <div class=""mt-3 col-12 text-center"">
                    <a class=""btn btn-primary btn-xl js-scroll-trigger disabled"" id=""rmd-confirm"" href=""#mapsection""><i id=""button-spinner"" class=""fa fa-circle-o-notc");
                WriteLiteral(@"h fa-spin""></i>&nbsp;Loading</a>
                </div>
        ...
        <div class=""container-fluid"">
            <div class=""container-fluid"">
                    ...
                    <div id=""culture-card"" class=""culture-card rounded shadow-lg bg-white"" style=""max-width: 500px; display: none;"">
                        <div class=""card"" id=""culture-card-content"" style=""display:block"">
                            <div width=""350"" height=""30"" id=""culture-info-content"">
                                <h2 class=""font--20 text--l");
                WriteLiteral(@"ebel font--bold p-4"" id=""culture-title""></h2>
                ...
                WriteLiteral(@"             </span>
                            ...
                            <div class=""px-2 pb-2"" style=""height:500px"" id=""more-content-r"">
                                <div class=""row"">
                                    <div class=""col-12"">
                  ...
                  ");
                WriteLiteral(@"                  <canvas id=""myChart""></canvas>
                                </div>
                            </div>
 ...
 ");
                            ...
                            <div class=""px-2 pb-2"" id=""more-content"">
                                <div class=""row"">
                                    <div class=""col-12"">
                                        ...
                                        <p class=");
                WriteLiteral(@"""font--18 subtitle--color mt-1"" id=""card-subtitle"">
               ...
               ");
                WriteLiteral("         <button id=\"byValue\" class=\"btn btn-info\"> Top 10 Max</button>\r\n                    </div>\r\n                    <br>\r\n                    <div id=\"barchart\"></div>\r\n                </div>\r\n            </div>\r\n\r\n        </div>\r\n\r\n    </section>\r\n");
                EndContext();
                BeginContext(37969, 11840, true);
                WriteLiteral(@"
    <!-- Footer -->
    <footer>
        <div class=""container"">
        ...
        function initialiseColor() {
           ...
           ");
            ...
            $.ajax({
                ...
                url: '");
                EndContext();
                BeginContext(49810, 34, false);
#line 1257 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                 Write(Url.Action("setCodeColors", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(49844, 1388, true);
                WriteLiteral(@"',
                /**/
                type: 'POST',
        ...
        function showMore(LGA_Code, rate1, rate2, rate3, rate4, rate5, noOfBsn) {
            ...
            $.ajax({
                ...
                url: '");
                EndContext();
                BeginContext(51233, 28, false);
#line 1303 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                 Write(Url.Action("getMore", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(51261, 6369, true);
                WriteLiteral(@"',
                /**/
                type: 'POST',
                data: { code: LGA_Code },
        ...
        function getTextByRate(rate) {
            ...
            return rate == 0 ? ""Empty"" : rate > 7 ? ""Good"" : rate > 3 ? ""Average"" : ""Bad"";
        }
    ...
    function flytoPoly(LGA_Code, option=1) {
        ...
        if (features) {
           ...
           ");
                ...
                EndContext();
                BeginContext(57631, 30, false);
#line 1458 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                             Write(Url.Action("getLngLat", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(57661, 9645, true);
                WriteLiteral(@"',
                            /**/
                            type: 'POST',
                            data: { code: LGA_Code },
...
");
        ...
        function initialIndustryListR() {
            ...
            /**/
                url: '");
                EndContext();
                BeginContext(67307, 35, false);
#line 1797 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
                 Write(Url.Action("getAllIndustry", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(67342, 1047, true);
                WriteLiteral(@"',
            /**/
            type: 'POST',
            data: { },
        ...
        function initialCountryListR() {
            ...
            /");
                WriteLiteral("**/\r\n            url: \'");
                EndContext();
                BeginContext(68390, 34, false);
#line 1825 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
             Write(Url.Action("getAllCountry", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(68424, 2223, true);
                WriteLiteral(@"',
            /**/
            type: 'POST',
            data: { },
    ...
    function recommendation() {
        ...
        document.querySelector('#card");
                ...
                EndContext();
                BeginContext(70648, 38, false);
#line 1888 "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Recommendation.cshtml"
             Write(Url.Action("getRecommendation", "Map"));

#line default
#line hidden
                EndContext();
                BeginContext(70686, 2550, true);
                WriteLiteral(@"',
            /**/
            type: 'POST',
