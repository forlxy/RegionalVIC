#pragma checksum "C:\Users\kasal\Source\Repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cbe2040f838775875bc4fc9ffa97211b441dbbaa"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cbe2040f838775875bc4fc9ffa97211b441dbbaa", @"/Views/Map/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dd2d01e42ee14e6ea13ed83d6ccebc59", async() => {
    ...
    ");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(16115, 65099, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "461ef77f4fed4a88a364d8da2b21caa0", async() => {
...
");
    ...
    <script>
      ...
      ");
                WriteLiteral(@"                  if (parseInt(feature.properties.LGA_CODE18) === LGA_Code) {
        ...
        map.on('load', function () {
            ...
            map.addSource(""states"", {
                ""type"": ""geojson"",
 ");
                WriteLiteral(@"               ""data"": ""https://raw.githubusercontent.com/kasaluoqi/root/master/LGA_2018_AUST_VIC_ID.geojson""
            });
            ...
            //        ""text-color"": ""#333"",
            //        ""text-halo");
                WriteLiteral(@"-color"": ""hsl(0, 0%, 100%)"",
            //        ""text-halo-width"": 1.5,
            //        ""text-halo-blur"": 1
            //    }
            //});
         ...
         ");
                WriteLiteral(@"   map.on(""mouseleave"", ""state-fills"", function () {
            ...
            map.on('mousemove', ""cheo"", function (e) {
                ...
                if (states.length > 0) {
                    ...
                    document.getElementById('pd').innerHTML = '<p>Hover over a state!");
                WriteLiteral(@"</p>';
                }
        ...
        function changeSelect() {
            ...
            if (typeSelectValue == ""House"") {
                ...
                $(""#sel1"").val(""1"");
                $('#sel1').fi");
                WriteLiteral(@"nd('option:contains(4)').prop('disabled', true);
            }
        }
        ...
        $(document).ready(function () {
         ...
         ");
            ...
            //    } else {
            //        $("".mmap"").css(""bot");
                WriteLiteral(@"tom"", 100 - $(window).scrollTop() );
            //    }
            //});
       ...
       ");
                WriteLiteral(@" var displayList = new Object
        //Show filter map
            ...
            if (option == ""a"") {
                ...
                for (var i = 0; i < allCode.length; i++) {
                    ...
                    $.ajax({
                        url: '");
                EndContext();
                BeginContext(61351, 30, false);
#line 1511 "C:\Users\kasal\Source\Repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Map\Index.cshtml"
                         Write(Url.Action("getMedian", "map"));

#line default
#line hidden
                EndContext();
                BeginContext(61381, 19826, true);
                WriteLiteral(@"',
                        type: 'POST',
                        data: ""{code:'"" + allCode[i] + ""', bedroom:'"" + sel1 + ""', type:'"" + sel2 + ""'}"",
                        contentType: 'Application/json',
                        success: function(data)
                        {
                            cheo[allCode[i]] = getColor(parseInt(data))
                    ...
                    //dis");
                WriteLiteral(@"playList[[allCode[i]]] = parseInt(getItem(tmpList[0], ""median"")) != 0 ? ""House median is $"" + parseInt(getItem(tmpList[0], ""median""))
       ...
       ");
                WriteLiteral(@"         var objects = crimeTable;
                ...
                map.setPaintProperty(""cheo"", 'fill-color', [""get"", [""to-string"", [""get"", ""LGA_CODE18""]],");
                WriteLiteral(@" [""literal"", crimeCheo]]);
                ...
                for (var j = 0; j < objects.length; j++) {
                    for (var i = 0; i < allCode.length; i++) {
                        ...
                        if (object != null && parseInt(object[""LGA Code""]) == allCode[i]) {
                            displayList[[allCode[i]]] = parseFloat(object[""Density""]) != 0 ? ""Density: "" + parseFloat(object[""Density""]).toFi");
                WriteLiteral(@"xed(2) + "". <p>Population: "" + parseInt(object[""Population""]) + '</p>' : ""No record"";
        ...
        //    } else {
     ");
                WriteLiteral(@"   //        map.classList.remove(""sticky"");
        //    }
        //}
        ...
        function processData(allText) {
            ...
            for (var i = 1; i < allTextLines.length");
                WriteLiteral(@"; i++) {
   ...
   ");
        ...
        function recommendation() {
            ...
            var maxBudget = isNaN(maxBudget) ? 1000 : maxBudg");
                WriteLiteral(@"et;
            ...
            for (var i = 0; i < allCode.length; i++) {
                ...
                for (var j = 0; j < objects.length; j++) {
                    ...
                    if (object != null && object[""LGA_Code""] != """" && object[""median""] != null &&
                        parseInt(object[""LGA_Code""]) === allCode[i]) {
                        if (object[""year""] == ""2018"") {
                            rates[allCode[i]] = acmWeight * getRatingByPrice(parseI");
                WriteLiteral(@"nt(object[""median""]));
                            break;
                        }
                    }
                }
            ...
            for (var i = 0; i < 10; i++) {
                var recomdList = document.getElemen");
                WriteLiteral(@"tById('recomd-list');
                recomdList.innerHTML += '<a href=""javascript:flytoPoly(' + parseInt(list[i][""LGA_Code""]) + ')"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
            ...
            if (list.length == 0) {
                ...
                filterList.innerHTML += '<div class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">' +
                    'No record within this price range</h5> <small class=""text-muted"" ></small> </div> <p class=""");
                WriteLiteral(@"mb-1"">'
        ...
        function filter() {
            ...
            if (list.length == 0) {
                var filterList = document.getElementById('list');
                filterList.innerHTML += '<div class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-");
                WriteLiteral(@"100 justify-content-between"" > <h6 class=""mb-1"">' +
        ...
        function showPolygonArea(e) {
            ...
            e.layer.");
                WriteLiteral(@"bindPopup((LGeo.area(e.layer) / 1000000).toFixed(2) + ' km<sup>2</sup>');
            e.layer.openPopup();
        }</script>
