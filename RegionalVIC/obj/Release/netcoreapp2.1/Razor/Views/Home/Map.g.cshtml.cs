#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Home\Map.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "901882331cbd3db472e6dcdad7079c2336db392f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"901882331cbd3db472e6dcdad7079c2336db392f", @"/Views/Home/Map.cshtml")]
...
");
            EndContext();
            BeginContext(794, 2773, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "844577cfd2184c1381f55e996165edd1", async() => {
                BeginContext(800, 2760, true);
                WriteLiteral(@"
    <meta charset=""utf-8"">
    ...
    <script src='https://api.tiles.mapbox.com/mapbo");
                WriteLiteral(@"x-gl-js/v0.53.1/mapbox-gl.js'></script>
...
");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(3571, 35253, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c49342187ad2451a822b8ff773ff6913", async() => {
                BeginContext(3577, 5172, true);
                WriteLiteral(@"
            ...
            <div class=""row"">
                ...
                WriteLiteral(@"ouse Price</h4>
                    ...
                    <div id='state-crime-legend' class='legend' style=""display: none"">
                        <h4>Crime rate</h4>
                        <div><span style='background-color: #7");
                WriteLiteral(@"23122'></span>10%</div>
                ...
                <div class=""col-md-4"">
                    ...
                    <ul class=""nav nav-tabs"">
                        ...
                        <li><a data-toggle=""tab"" href=""#satety"">Satet");
                WriteLiteral(@"y</a></li>
                    </ul>
                ...
                WriteLiteral("     </select>\r\n                            </div>\r\n");
                EndContext();
                BeginContext(9046, 230, true);
                WriteLiteral("                            <button type=\"button\" class=\"btn btn-primary\" onclick=\"choropleth(\'a\')\">Show</button>\r\n                            <button type=\"button\" class=\"btn btn-primary\" onclick=\"resetLayer()\">Reset</button>\r\n\r\n");
                EndContext();
                BeginContext(9340, 29477, true);
                WriteLiteral(@"
                            <div class=""form-group"">
                            ...
                            <div id='list' class=""list-group"">
                                <a href=""#"" class=""list-group-item list-group-item-action flex-column align-items-start active"">
                                    ...
                                    <sm");
                WriteLiteral(@"all>Donec id elit non mi porta.</small>
                                </a>
    ...
    <script>
        ...
        var allCode = [20110, 20260, 20570, 20660, 20740, 20830, 20910, 21010, 21110, 21180, 21270, 21370, 21450, 21610, 21670, 21750, 21830, 21890, 22110, 22170, 22250, 22310, 22410, 22490, 22620, 22670, 22750, 22830, 22910, 22980, 23110, 23190, 23270, 23350, 23430, 23670, 2");
                WriteLiteral(@"3810, 23940, 24130, 24210, 24250, 24330, 24410, 24600, 24650, 24780, 24850, 24900, 24970, 25060, 25150, 25250, 25340, 25430, 25490, 25620, 25710, 25810, 25900, 25990, 26080, 26170, 26260, 26350, 26430, 26490, 26610, 26670, 26700, 26730, 26810, 26890, 26980, 27070, 27170, 27260, 27350, 27450, 27630, 29399, 29499, 29799];
  ...
  ");
                WriteLiteral(@"          rcMap.set('25620', getRandomColor());
      ...
      ");
                WriteLiteral(@"      rcMap.set('27260', getRandomColor());
        ...
        function initialiseColor() {
         ...
         ");
                WriteLiteral(@"       ""25620"": rcMap.get('25620'),
                ...
                ""2745");
                WriteLiteral(@"0"": rcMap.get('27450'),
        ...
        map.on('load', function () {
            ...
            map.addLayer({
                ...
                ""paint"": {
                    ...
                    ""fill-opacity"": [""case"",
                   ");
                WriteLiteral(@"     [""boolean"", [""feature-state"", ""hover""], false],
                        0.7,
                        0.3
                    ]
                }
            ...
            // featur");
                WriteLiteral(@"e state for the feature under the mouse.
   ...
   ");
        ...
        function choropleth(option) {
            //map.setPaintProperty('state-fills', 'fill-color', getColor(parseInt(getItem(getItems(table, [
            //    ""to-string"", [""get"", ""LGA_CODE18""]
            //], ""bedroom"", ""1"", ""year"", ""2018"")[0]),""median""))
            //);
            if (option == ""a"") {
        ...
        ");
                ...
                WriteLiteral(@"""get"", ""LGA_CODE18""]], [""literal"", crimeCheo]]);
        ...
        function forwardGeocoder(query) {
            ...
            for (var i = 0; i < customData.features.length; i++) {
                ...
                if (feature.properties.LGA_NAME18.toLowerCase().search(query.toLowerCase()) !== -1) {
                  ");
                WriteLiteral(@"  // add a tree emoji as a prefix for custom data results
                ...
                if (object != null && parseInt(object[""LGA_Code""]) == parseInt(lgaCode)) {
                    ...
                    for (var j = 0; j < Object.keys(args).length; j++) {
                        ...
                        if (attriValue != null && attriName != null &&
                            ...
                            //if (year != """" && yearValue != """")
                            //    if (object[""year""] ");
                WriteLiteral(@"== yearValue && object[""median""] != """")
                            //        list.push(object);
                            //    else
                            //        continue;
                            //else
