#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Home\Map.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7505e9b8fbdd6a67c734da24c4f16162f5959892"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7505e9b8fbdd6a67c734da24c4f16162f5959892", @"/Views/Home/Map.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "41bbb4e8ed554c31ae0f33fdabd45b60", async() => {
...
");
            ...
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(14819, 48286, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b1b98522b7554ab183eaa5d7d8a3afe0", async() => {
...
");
                ...
                WriteLiteral(@"
                            ...
                            <div class=""form-group row"">
                               ...
                               ");
                WriteLiteral(@"     <input type=""text"" class=""form-control"" id=""max-bgt-recom"">
                                </div>
                            </div>
    ...
    <script>
        ...
        var allCode = [20110, 20260, 20570, 20660, 20740, 20830, 20910, 21010, 21110, 21180, 21270, 21370, 21450, 21610, 21670, 21750, 21830, 21890, 22110, 22170, 22250, 22310, 22410, 22490, 22620, 22670, 22750, 22830, 22910, 22980, 23110, 23190, 23270, 23350, 23430, 23670, 23810, 23940, 24130, 24210, 24250, 24330, 24410, 24600, 24650, 24780, 24850, 24900, 24970, 25060,");
                WriteLiteral(@" 25150, 25250, 25340, 25430, 25490, 25620, 25710, 25810, 25900, 25990, 26080, 26170, 26260, 26350, 26430, 26490, 26610, 26670, 26700, 26730, 26810, 26890, 26980, 27070, 27170, 27260, 27350, 27450, 27630, 29399, 29499, 29799];
...
");
                WriteLiteral(@"            rcMap.set('27450', getRandomColor());
 ...
 ");
                WriteLiteral(@"               ""23670"": rcMap.get('23670'),
             ...
             ");
                WriteLiteral(@"   ""25810"": rcMap.get('25810'),
...
");
       ...
       ");
                ...
                //        chart.destroy();
                //        ctx = ");
                WriteLiteral(@"document.getElementById(""myChart"").getContext(""2d"");
                //        chart = new Chart(ctx, {
        ...
        $(document).ready(function () {
            $.getJSON('https://raw.githubusercontent.com/kasaluoqi/root/master/LGA_2018_AUST_VIC_ID.geojson");
 ...
 ");
                WriteLiteral(@"       var stateCrimeLegend = document.getElementById('state-crime-legend');
        function resetLayer() {
                ...
                for (var j = 0; j < objects.length; j++) {
                    for (var i = 0; i < allCode.length; i++) {
                        ...
                        if (object != null && object[""Year""] == ""2018"" &&
                            parseInt(object[""LGA_Code""]) == a");
                WriteLiteral(@"llCode[i]) {
        ...
        function forwardGeocoder(query) {
            ...
            for (var i = 0; i < customData.features.length; i++) {
                ...
                if (feature.properties.LGA_NAME18.toLowerCase().search(query.toLowerCase()) !== -1) {
                    ...
                    // using c");
                WriteLiteral(@"armen geojson format: https://github.com/mapbox/carmen/blob/master/carmen-geojson.md
        ...
        function recommendation() {
            ...
            for (var i = 0; i < allCode.length; i++) {
                ...
                for (var j = 0; j < objects.length; j++) {
                    var object = objects[j];
                   ");
                WriteLiteral(@" if (object != null && object[""LGA_Code""] != """" && object[""median""] != null &&
                        parseInt(object[""LGA_Code""]) === allCode[i]) {
                        if (object[""year""] == ""2018"") {
                            rates[allCode[i]] = 0.6 * getRatingByPrice(parseInt(object[""median""]));
                            break;
                        }
                    }
                }
            ...
            for (var i = 0; i < allCode.length; i++) {
                for (var j = 0; j < objects.length; j++) {
                    ...
                    if (rates[allCode[i]] != -1 && object != null && object[""LGA_Code""] != """" 
                        && object[""Year""] == ""2018"" && object[""Rate""] != null &&
                        parseInt(object[""LGA_Code""]) === allCode[i]) {
                        rates[allCode[i]] += 0.4 * getRatingByCrime(parseFloat(object[""Rate""]));
                        break;
                    }
                }
    ");
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                recomdList.innerHTML += '<a href=""#"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
                    + list[i][""region""] + '</div> <p class=""mb-1"">'
                    + ""Rate: "" + rates[parseI");
                WriteLiteral(@"nt(list[i][""LGA_Code""])].toFixed(2) + '</p> </a>';
        ...
        function filter() {
            ...
            for (var i = 0; i < list.length; i++) {
                var filterList ");
                WriteLiteral(@"= document.getElementById('list');
        ...
        function processNumber(str) {
            ...
            return val;
                         ...
                         ");
                WriteLiteral(@"                   //    tableNumericField: 'median',
