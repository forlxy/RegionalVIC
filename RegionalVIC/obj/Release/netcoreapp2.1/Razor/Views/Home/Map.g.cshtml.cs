#pragma checksum "C:\Users\kasal\source\repos\kasaluoqi\RegionalVIC\RegionalVIC\Views\Home\Map.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "304432e7ea48a6bbdcde15f3e5441746494eac40"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"304432e7ea48a6bbdcde15f3e5441746494eac40", @"/Views/Home/Map.cshtml")]
...
");
            EndContext();
            BeginContext(14270, 2170, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3278db7ef0f54b6c909e21ba68df645f", async() => {
                BeginContext(14276, 2157, true);
                WriteLiteral(@"
    ...
    <script src='https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geoc");
            ...
            EndContext();
            BeginContext(16440, 4, true);
            WriteLiteral("\r\n\r\n");
            EndContext();
            BeginContext(16444, 59137, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d469814157ed48ee9205ed391c3a8cff", async() => {
                BeginContext(16450, 8578, true);
                WriteLiteral(@"
...
");
   ...
   ");
                ...
                var map = new mapboxgl.Map({
                    container: 'map',
                    style: 'mapbox");
                WriteLiteral(@"://styles/mapbox/light-v9',
                ...
                WriteLiteral(@"
                   ...
                   ");
                WriteLiteral(@" rcMap.set('23940', getRandomColor());
...
");
               ...
               ");
                WriteLiteral(@" function readData(filename) {
                    $.ajax({
                        type: ""GET"",
                        url: ""/"" + filename,
                        dataType: ""text"",
   ...
   ");
                ...
                function choropleth(option) {
                 ...
                 ");
                WriteLiteral(@"               + "". Number of recorded house: "" + parseInt(getItem(tmpList[0], ""count"")) : ""No record"";
                        ...
                        for (var j = 0");
                WriteLiteral(@"; j < objects.length; j++) {
                            for (var i = 0; i < allCode.length; i++) {
   ...
   ");
                ...
                function recommendation() {
                    ...
                    var crmWeight = p");
                WriteLiteral(@"arseFloat(crmSlider.value);
                ...
                WriteLiteral(@"
                    ...
                    for (var i = 0; i < allCode.length; i++) {
                        for (var j = 0; j < objects.length; j++) {
                            ...
                            if (rates[allCode[i]] != -1 && object !");
                WriteLiteral(@"= null && object[""LGA Code""] != """"
                                && object[""Density""] != null &&
                    ...
                    list.sort((a, b) => (rates[parse");
                WriteLiteral(@"Int(a.LGA_Code)] < rates[parseInt((b.LGA_Code))]) ? 1 : -1)
                    for (var i = 0; i < list.length; i++) {
                        ...
                        recomdList.innerHTML += '<a href=""#"" class=""list-group-item list-group-item-action flex-column align-items-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
                            + list[i][""LGA""] + '</h5> <small class=""text-muted"" >' + list[i][""type""].toUpperCase() + "", B"" + parseInt(list[i][""bedroom""]) + '</small> </div > <p class=""mb-1"">'
                ...
                function filter() {
                    ...
                    var minBudget = parseInt(document.getElemen");
                WriteLiteral(@"tById(""min-bgt"").value);
                    ...
                    for (var i = 0; i < list.length; i++) {
                        var filterList = document.getElementById('list');
                        filterList.innerHTML += '<a href=""#"" class=""list-group-item list-group-item-action flex-column align-items");
                WriteLiteral(@"-start"">   <div class=""d-flex w-100 justify-content-between"" > <h5 class=""mb-1"">'
